...
namespace Uraty.Feature.Player
{
    ...
    public class PlayerAimFromInterpreter : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                name = $"{nameof(PlayerAimFromInterpreter)}_{nameof(_predictionMesh)}"
            };
        ...
        private void Update()
        {
            ...
            if (!_isAiming)
            {
                ...
                else if (_playerInputInterpreter.SuperPressedThisFrame && HasDefinition(AimActionType.Special))
                {
        ...
        private bool IsCurrentAimButtonPressed()
        {
            ...
            switch (_currentAimActionType)
            {
                case AimActionType.Attack:
                    return _playerInputInterpreter.AttackIsPressed;

                case AimActionType.Special:
                    return _playerInputInterpreter.SuperIsPressed;
        ...
        private bool WasCurrentAimButtonReleased()
        {
            ...
            {
                case AimActionType.Attack:
                    return _playerInputInterpreter.AttackReleasedThisFrame;

                case AimActionType.Special:
                    return _playerInputInterpreter.SuperReleasedThisFrame;
